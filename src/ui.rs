...
pub(crate) use self::{
    ...
    sidebar::{
        ...
        pane_section_rect, pane_section_scroll_metrics, pane_section_scrollbar_rect,
...
fn compute_view_internal(
    ...
    // Mutation phase: keep the manual agent order and Panes-section order
    ...
    if !app.sidebar_collapsed {
        ...
        let detail_area = agents_detail_rect(
            sidebar_area,
        ...
        let pane_section_area = pane_section_rect(
            sidebar_area,
            app.sidebar_section_split,
            app.sidebar_pane_section_split,
            sidebar_shows_pane_section(app),
        ...
        app.pane_section_scroll = app.pane_section_scroll.min(max_tab_scroll);
    } else {
    ...
    let pane_section_row_areas = if app.sidebar_collapsed {
        Vec::new()
    } else {
        let pane_section_area = pane_section_rect(
            sidebar_area,
